...
(function($PS) {
  ...
  var fragmentName = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(name)(function (x) {
      var $111 = x === "on";
      if ($111) {
  ...
  var namedType = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.NamedType)(name);
  var variable = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.Variable)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("$"))(name));
  var uni = Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(digits)(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "A", "B", "C", "D", "E", "F" ])([ "a", "b", "c", "d", "e", "f" ])));
  var comment = Data_Functor["void"](Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("#"))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_String.noneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)([ "\x0a" ]))));
  var comma = Data_Functor["void"](Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(","));
  var ignorable = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(lineTerminator)(comma))(comment))(whitespace);
  var ignoreMe = Data_Functor["void"](Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(ignorable));
  var directiveLocations = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))((function () {
      var $119 = Data_List.fromFoldable(Data_List_Types.foldableNonEmptyList);
      return function ($120) {
          return Data_GraphQL_AST.DirectiveLocations($119($120));
      };
  })())(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_Combinators.optional(Data_Identity.monadIdentity)(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("|"))))(Text_Parsing_Parser_Combinators.sepBy1(Data_Identity.monadIdentity)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(directiveLocation))(ignoreMe))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("|"))));
  ...
  })(name))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(implementsInterfaces)));
  var operationTypeDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.OperationTypeDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return {
              operationType: v,
              namedType: v1
  ...
  })(operationType))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(":")))(ignoreMe))(namedType)));
  var rootOperationDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.RootOperationTypeDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return {
              operationType: v,
              namedType: v1
  ...
  var typeCondition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.TypeCondition)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("on"))(ignoreMe))(namedType));
  var unionMemberTypes = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))((function () {
      var $123 = Data_List.fromFoldable(Data_List_Types.foldableNonEmptyList);
      return function ($124) {
          return Data_GraphQL_AST.UnionMemberTypes($123($124));
      };
  })())(Text_Parsing_Parser_Combinators.sepBy1(Data_Identity.monadIdentity)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(namedType))(ignoreMe))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("|")));
  var ca2str = (function () {
      var $125 = Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity));
      return function ($126) {
          return $125(Data_String_CodeUnits.fromCharArray($126));
      };
  })();
  var simpleUnicodeString = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))([ Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\\"))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("u")))(uni), uni, uni, uni ]))(ca2str))((function () {
      var $127 = Data_Maybe.maybe(Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("Unrepresentable code point"))((function () {
          var $130 = Data_Maybe.maybe(Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("Unrepresentable code point"))((function () {
              var $133 = Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity));
              return function ($134) {
                  return $133(Data_String_CodePoints.singleton(Data_String_CodePoints.codePointFromChar($134)));
              };
          })());
          var $131 = Data_Enum.toEnum(Data_Enum.boundedEnumChar);
          return function ($132) {
              return $130($131($132));
          };
      })());
      var $128 = Data_Int.fromStringAs(Data_Int.hexadecimal);
      return function ($129) {
          return $127($128($129));
      };
  })());
  var tripleQuote = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))([ Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\""), Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\""), Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\"") ]))(ca2str);
  var c2str = (function () {
      var $135 = Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity));
      return function ($136) {
          return $135(Data_String_CodeUnits.fromCharArray(Data_Array.singleton($136)));
      };
  })();
  var exponentPart = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Foldable.fold(Data_Foldable.foldableArray)(Data_Monoid.monoidString))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))([ Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)([ "e", "E" ]))(c2str), Text_Parsing_Parser_Combinators.option(Data_Identity.monadIdentity)("")(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)([ "+", "-" ]))(c2str)), Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Array.some(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(digits)))(ca2str) ]));
  ...
  var negativeSign = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("-"))(c2str);
  var ip0 = Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Semigroup.append(Data_Semigroup.semigroupString))(Text_Parsing_Parser_Combinators.option(Data_Identity.monadIdentity)("")(negativeSign)))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("0"))(c2str));
  var ipOther = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Foldable.fold(Data_Foldable.foldableArray)(Data_Monoid.monoidString))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))([ Text_Parsing_Parser_Combinators.option(Data_Identity.monadIdentity)("")(negativeSign), Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(nonZeroDigits))(c2str), Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(digits)))(ca2str) ]));
  var integerPart = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(ip0))(ipOther);
  var floatValueExp = Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Semigroup.append(Data_Semigroup.semigroupString))(integerPart))(exponentPart);
  var floatValueFrac = Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Semigroup.append(Data_Semigroup.semigroupString))(integerPart))(fractionalPart);
  var floatValueFracExp = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Foldable.fold(Data_Foldable.foldableArray)(Data_Monoid.monoidString))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))([ integerPart, fractionalPart, exponentPart ]));
  var floatValue = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(floatValueFracExp))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(floatValueExp)))(floatValueFrac))((function () {
      var $137 = Data_Maybe.maybe(Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("String not a float"))((function () {
          var $139 = Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity));
          return function ($140) {
              return $139(Data_GraphQL_AST.FloatValue($140));
          };
      })());
      return function ($138) {
          return $137(Data_Number.fromString($138));
      };
  })());
  var intValue = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(integerPart)((function () {
      var $141 = Data_Maybe.maybe(Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("String not an int"))((function () {
          var $143 = Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity));
          return function ($144) {
              return $143(Data_GraphQL_AST.IntValue($144));
          };
      })());
      return function ($142) {
          return $141(Data_Int.fromString($142));
      };
  })());
  var notTripleQuote = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.lookAhead(Data_Identity.monadIdentity)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))([ Text_Parsing_Parser_String.anyChar(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity), Text_Parsing_Parser_String.anyChar(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity), Text_Parsing_Parser_String.anyChar(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity) ])))(function (s) {
      var $112 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqChar))(s)([ "\"", "\"", "\"" ]);
      if ($112) {
          return Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("this is a triple quote");
      };
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.anyChar(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity))(c2str);
  });
  var simpleEscapedString = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\\"))(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)([ "\"", "\\", "/", "b", "f", "n", "r", "t" ])))(function (x) {
      if (x === "\"") {
  ...
  var simpleUnescapedString = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.noneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)([ "\\", "\"", "\x0a" ]))(c2str);
  var simpleStringSingleton = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(simpleUnescapedString))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(simpleUnicodeString)))(simpleEscapedString);
  var singleQuote = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\""))(c2str);
  var simpleStringValue = Text_Parsing_Parser_Combinators.between(Data_Identity.monadIdentity)(singleQuote)(singleQuote)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Foldable.fold(Data_Foldable.foldableArray)(Data_Monoid.monoidString))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(simpleStringSingleton)));
  var booleanValue = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.BooleanValue)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("true"))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(true)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("false"))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(false))));
  var blockStringValue = Text_Parsing_Parser_Combinators.between(Data_Identity.monadIdentity)(tripleQuote)(tripleQuote)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Foldable.fold(Data_Foldable.foldableArray)(Data_Monoid.monoidString))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(notTripleQuote)));
  var stringValue = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.StringValue)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(blockStringValue))(simpleStringValue));
  var description = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(stringValue)(function (v) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(v);
  });
  var optDesc = ooo(description);
  var argument = function (vc) {
      ...
      })(name))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(":")))(ignoreMe))(vc)));
  };
  var alias = Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(name)(ignoreMe))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(":"));
  var _type = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (p) {
      return Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.Type_NonNullType.create)(nonNullType(p))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.Type_NamedType.create)(namedType))))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.Type_ListType.create)(listType(p))))("type");
  });
  var _listish1 = function (p) {
      return Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_List.fromFoldable(Data_List_Types.foldableList))(sepEndBy1_(Data_Identity.monadIdentity)(p)(ignoreMe));
  };
  var _listish = function (p) {
      return sepEndBy_(Data_Identity.monadIdentity)(p)(ignoreMe);
  };
  var listish = function (o) {
      return function (c) {
          return function (p) {
              return Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(o))(ignoreMe))(_listish(p)))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(c));
          };
      };
  };
  var listValue = (function () {
      var $145 = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.ListValue);
      var $146 = listish("[")("]");
      return function ($147) {
          return $145($146($147));
      };
  ...
  var directives = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.Directives)(_listish1(directive));
  var enumTypeExtensionWithDirectives = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.EnumTypeExtension_With_Directives.create)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return {
              name: v,
              directives: v1
  ...
  })(name))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(directives)));
  var inputObjectTypeExtensionWithDirectives = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.InputObjectTypeExtension_With_Directives.create)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return {
              name: v,
              directives: v1
  ...
  var interfaceTypeExtensionWithDirectives = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.InterfaceTypeExtension_With_Directives.create)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return {
              name: v,
              directives: v1
  ...
  })(name))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo(implementsInterfaces))))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(directives)));
  var optDir = ooo(directives);
  var enumValueDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.EnumValueDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return {
                  description: v,
  ...
  })(optDesc))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(enumValue)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)));
  var enumValuesDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.EnumValuesDefinition)(listish("{")("}")(enumValueDefinition));
  var enumTypeDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.EnumTypeDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return {
  ...
  })(optDesc))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("enum")))(ignoreMe))(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo(enumValuesDefinition))));
  var enumTypeExtensionWithEnumValuesDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.EnumTypeExtension_With_EnumValuesDefinition.create)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return {
                  name: v,
  ...
  })(name))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(enumValuesDefinition)));
  var enumTypeExtension = Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignorableExtension("enum"))(ignoreMe))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(enumTypeExtensionWithEnumValuesDefinition))(enumTypeExtensionWithDirectives))("enumTypeExtension"));
  var fragmentSpread = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.FragmentSpread)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return {
              fragmentName: v,
              directives: v1
  ...
  })(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("..."))(ignoreMe))(fragmentName)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)));
  var inlineFragment = function (ss) {
      ...
      })(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("..."))(ignoreMe))(ooo(typeCondition))))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ss)));
  };
  var scalarTypeDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.ScalarTypeDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return {
                  description: v,
  ...
  })(optDesc))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("scalar")))(ignoreMe))(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)));
  var unionTypeDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.UnionTypeDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return {
  ...
  })(optDesc))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("union")))(ignoreMe))(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("=")))(ignoreMe))(ooo(unionMemberTypes))));
  ...
  })(name))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("=")))(ignoreMe))(unionMemberTypes)));
  var scalarTypeExtension = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.ScalarTypeExtension)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return {
              name: v,
              directives: v1
  ...
  })(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignorableExtension("scalar"))(ignoreMe))(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(directives)));
  var schemaExtensionWithDirectives = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.SchemaExtension_With_Directives.create)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return {
          directives: v
      };
  })(directives));
  var unionTypeExtensionWithDirectives = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.UnionTypeExtension_With_Directives.create)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return {
              name: v,
              directives: v1
  ...
  var unionTypeExtension = Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignorableExtension("union"))(ignoreMe))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(unionTypeExtensionWithUnionMemberTypes))(unionTypeExtensionWithDirectives))("unionTypeExtension"));
  var field = function (ss) {
      ...
      })(ooo(alias)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo($$arguments))))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo(ss))));
  };
  var selection = function (ss) {
      return Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.Selection_Field.create)(field(ss))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.Selection_FragmentSpread.create)(fragmentSpread))))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.Selection_InlineFragment.create)(inlineFragment(ss))))("selection");
  };
  var defaultValue = Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("="))(ignoreMe))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.DefaultValue)(value));
  var optDv = ooo(defaultValue);
  var inputValueDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.InputValueDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return function (v4) {
  ...
  })(optDesc))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(":")))(ignoreMe))(_type)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDv)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)));
  var argumentsDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.ArgumentsDefinition)(listish("(")(")")(inputValueDefinition));
  var directiveDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.DirectiveDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return {
  ...
  })(optDesc))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("directive")))(ignoreMe))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("@")))(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo(argumentsDefinition))))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("on")))(ignoreMe))(directiveLocations)));
  var fieldDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.FieldDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return function (v4) {
  ...
  })(optDesc))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo(argumentsDefinition))))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(":")))(ignoreMe))(_type)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)));
  var fieldsDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.FieldsDefinition)(listish("{")("}")(fieldDefinition));
  ...
  })(optDesc))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("interface")))(ignoreMe))(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo(fieldsDefinition))));
  var interfaceTypeExtensionWithFieldsDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.InterfaceTypeExtension_With_FieldsDefinition.create)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return {
                  name: v,
  ...
  })(name))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(fieldsDefinition)));
  var interfaceTypeExtension = Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignorableExtension("input"))(ignoreMe))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(interfaceTypeExtensionWithFieldsDefinition))(interfaceTypeExtensionWithDirectives))("interfaceTypeExtension"));
  var objectTypeDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.ObjectTypeDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return function (v4) {
  ...
  })(optDesc))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("type")))(ignoreMe))(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo(implementsInterfaces))))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo(fieldsDefinition))));
  var objectTypeExtensionWithFieldsDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.ObjectTypeExtension_With_FieldsDefinition.create)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return {
  ...
  })(name))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo(implementsInterfaces))))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(fieldsDefinition)));
  var objectTypeExtension = Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignorableExtension("type"))(ignoreMe))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(objectTypeExtensionWithFieldsDefinition))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(objectTypeExtensionWithDirectives)))(objectTypeExtensionWithImplementsInterfaces))("objectTypeExtension"));
  var inputFieldsDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.InputFieldsDefinition)(listish("{")("}")(inputValueDefinition));
  var inputObjectTypeDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.InputObjectTypeDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return {
  ...
  })(optDesc))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("input")))(ignoreMe))(name)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(ooo(inputFieldsDefinition))));
  ...
  })(name))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(inputFieldsDefinition)));
  var inputObjectTypeExtension = Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignorableExtension("input"))(ignoreMe))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(inputObjectTypeExtensionWithInputFieldsDefinition))(inputObjectTypeExtensionWithDirectives))("inputObjectTypeExtension"));
  ...
  var variableDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.VariableDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return {
                  variable: v,
  ...
  })(variable))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(":")))(ignoreMe))(_type)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(optDv)));
  var operationTypesDefinition = listish("{")("}")(operationTypeDefinition);
  var schemaExtensionWithOperationTypeDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.SchemaExtension_With_OperationTypeDefinition.create)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return {
              directives: v,
  ...
  })(optDir))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(operationTypesDefinition)));
  var schemaExtension = Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignorableExtension("schema"))(ignoreMe))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(schemaExtensionWithOperationTypeDefinition))(schemaExtensionWithDirectives))("schemaExtension"));
  var typeSystemExtension = Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.TypeSystemExtension_SchemaExtension.create)(schemaExtension)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.TypeSystemExtension_TypeExtension.create)(typeExtension)))("typeSystemExtension");
  var schemaDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.SchemaDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return {
              directives: v,
  ...
  })(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("schema"))(ignoreMe))(optDir)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(ignoreMe)(listish("{")("}")(rootOperationDefinition))));
  var typeSystemDefinition = Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.TypeSystemDefinition_SchemaDefinition.create)(schemaDefinition)))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.TypeSystemDefinition_TypeDefinition.create)(typeDefinition))))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.TypeSystemDefinition_DirectiveDefinition.create)(directiveDefinition)))("typeSystemDefinition");
  var selectionSet = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (p) {
      return Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.SelectionSet)(listish("{")("}")(selection(p)));
  });
  var fragmentDefinition = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_GraphQL_AST.FragmentDefinition)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return {
...
(function($PS) {
  ...
  var docComment = function (dictFoldable) {
      return Data_Foldable.foldMap(dictFoldable)(Data_Monoid.monoidString)(function (str) {
          return "\x0a" + (prependLines(commentPrefix)(str) + "\x0a");
      });
  };
...
(function($PS) {
  ...
  var gqlToPursMainSchemaCode = function (v) {
      return function (doc) {
          ...
          var startsWith = function (pre) {
              return function (str) {
                  return pre === Data_String_CodePoints.take(Data_String_CodePoints.length(pre))(str);
              };
          };
          var wrapNotNull = function (s) {
              var $52 = startsWith("(NotNull ")(Data_String_Common.trim(s));
              if ($52) {
                  return s;
              };
              return "(NotNull " + (s + ")");
          ...
          var rootOperationTypeDefinitionToPurs = function (v1) {
              var opStr = (function () {
                  ...
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 195, column 13 - line 198, column 41): " + [ v1.operationType.constructor.name ]);
              })();
          ...
          var namedTypeToPursNullable = function ($173) {
              return wrapMaybe(namedTypeToPurs_($173));
          };
          var typeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 404, column 16 - line 407, column 72): " + [ v1.constructor.name ]);
          };
          var notNullTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 418, column 23 - line 420, column 51): " + [ v1.constructor.name ]);
          };
          ...
          var getNullable = function (objectName) {
              return function (namedType) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(objectName)(v.nullableOverrides))(Data_Map_Internal.lookup(Data_Ord.ordString)(Data_Newtype.unwrap()(namedType)));
              };
          };
          var getDefinitionTypeName = (function () {
              var $174 = Data_Array.filter(function (l) {
                  return Data_String_CodePoints.take(Data_String_CodePoints.length(GraphQL_Client_CodeGen_Lines.commentPrefix))(l) !== GraphQL_Client_CodeGen_Lines.commentPrefix;
              });
              var $175 = Data_String_CodePoints.takeWhile(Data_Eq.notEq(Data_String_CodePoints.eqCodePoint)(Data_String_CodePoints.codePointFromChar("=")));
              return function ($176) {
                  return GraphQL_Client_CodeGen_Lines.fromLines($174(GraphQL_Client_CodeGen_Lines.toLines($175($176))));
              };
          })();
          ...
          var argTypeToPurs = function (objectName) {
              return function (v1) {
                  if (v1 instanceof Data_GraphQL_AST.Type_NamedType && Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqBoolean))(getNullable(objectName)(v1.value0))(new Data_Maybe.Just(false))) {
                  ...
                  if (v1 instanceof Data_GraphQL_AST.Type_NonNullType && (v1.value0 instanceof Data_GraphQL_AST.NonNullType_NamedType && Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqBoolean))(getNullable(objectName)(v1.value0.value0))(new Data_Maybe.Just(true)))) {
                      return argNotNullTypeToPurs(objectName)(v1.value0);
                  };
                  if (v1 instanceof Data_GraphQL_AST.Type_NonNullType) {
                      return wrapNotNull(argNotNullTypeToPurs(objectName)(v1.value0));
                  };
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 379, column 30 - line 386, column 100): " + [ v1.constructor.name ]);
              };
          };
          var argNotNullTypeToPurs = function (objectName) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 389, column 37 - line 391, column 65): " + [ v1.constructor.name ]);
              };
          };
              ...
              return function (v1) {
                  return inlineComment(v1.description) + (v1.name + (" :: " + (function () {
                      ...
                      if (v2 instanceof Data_Maybe.Just) {
                          if (v1.type instanceof Data_GraphQL_AST.Type_NonNullType && (v1.type.value0 instanceof Data_GraphQL_AST.NonNullType_NamedType && Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqBoolean))(getNullable(objectName)(v1.type.value0.value0))(new Data_Maybe.Just(true)))) {
                          ...
                          if (v1.type instanceof Data_GraphQL_AST.Type_NamedType && Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqBoolean))(getNullable(objectName)(v1.type.value0))(new Data_Maybe.Just(false))) {
                              return wrapNotNull(v2.value0.moduleName + ("." + v2.value0.typeName));
                          };
                          return v2.value0.moduleName + ("." + v2.value0.typeName);
                      };
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 366, column 10 - line 373, column 55): " + [ v2.constructor.name ]);
                  })()));
              };
          };
          ...
          var inputValueDefinitionsToPurs = function (v1) {
              return inlineComment(v1.description) + (v1.name + (" :: " + argTypeToPurs(v1.name)(v1.type)));
          };
          ...
          var fieldDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return inlineComment(v1.description) + (v1.name + (" :: " + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(argumentsDefinitionToPurs)(v1.argumentsDefinition) + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 282, column 10 - line 287, column 67): " + [ v2.constructor.name ]);
                  })())));
              };
          };
          ...
          var objectTypeDefinitionToPurs = function (v1) {
              ...
              return GraphQL_Client_CodeGen_Lines.docComment(Data_Foldable.foldableMaybe)(v1.description) + (function () {
                  if (v.useNewtypesForRecords) {
                      return "newtype " + (typeName_(v1.name) + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function (fd) {
                  ...
                  return "type " + (typeName_(v1.name) + Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function (fd) {
          ...
          var typeDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 201, column 26 - line 207, column 143): " + [ v1.constructor.name ]);
          };
          var typeSystemDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 180, column 32 - line 183, column 118): " + [ v1.constructor.name ]);
          };
          var definitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 174, column 22 - line 177, column 52): " + [ v1.constructor.name ]);
          };
  ...
  var gqlToPursEnums = function (gqlScalarsToPursTypes) {
      ...
      var $182 = Data_List.mapMaybe(definitionToEnum);
  ...
  var schemaFromGqlToPurs = function (opts) {
      return function (v) {
          return Data_Functor.mapFlipped(Data_Either.functorEither)(Text_Parsing_Parser.runParser(v.schema)(Data_GraphQL_Parser.document))(function (ast) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
                              if (eVal instanceof Data_Either.Right) {
                                  return v1.value0.set({
                                      ...
                                      })())()))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Class.gEncodeJsonNil)({
                                          reflectSymbol: function () {
                                              return "symbols";
                                          }
                                      })())({
...
(function($PS) {
  ...
  var schemasFromGqlToPursJs = (function () {
      var go = function (optsJs) {
          var opts = {
              externalTypes: Data_Map_Internal.fromFoldableWithIndex(Data_Ord.ordString)(Foreign_Object.foldableWithIndexObject)(fromNullable(Data_Monoid.mempty(Foreign_Object.monoidObject(Data_Semigroup.semigroupRecord()(Data_Semigroup.semigroupRecordCons({
                  reflectSymbol: function () {
                      return "moduleName";
                  }
              ...
              nullableOverrides: Data_Functor.map(Data_Map_Internal.functorMap)(Data_Map_Internal.fromFoldableWithIndex(Data_Ord.ordString)(Foreign_Object.foldableWithIndexObject))(Data_Map_Internal.fromFoldableWithIndex(Data_Ord.ordString)(Foreign_Object.foldableWithIndexObject)(fromNullable(Foreign_Object.empty)(optsJs.nullableOverrides))),
          ...
          var getError = function (err) {
              return {
                  ...
                  result: Data_Monoid.mempty(Data_Monoid.monoidRecord()(Data_Monoid.monoidRecordCons({
                      reflectSymbol: function () {
                          return "enums";
                      }
                  ...
                  })(Data_Monoid.monoidRecord()(Data_Monoid.monoidRecordCons({
                      reflectSymbol: function () {
                          return "code";
                      }
