...
(function($PS) {
  ...
  var template = function (modulePrefix) {
      return function (v) {
          ...
          return "module " + (modulePrefix + ("Enum." + (v.name + (" where\x0a\x0aimport Prelude\x0a\x0aimport Data.Argonaut.Decode (class DecodeJson, JsonDecodeError(..), decodeJson)\x0aimport Data.Argonaut.Encode (class EncodeJson, encodeJson)\x0aimport Data.Either (Either(..))\x0aimport Data.Function (on)\x0aimport GraphQL.Client.Args (class ArgGql)\x0aimport GraphQL.Client.ToGqlString (class GqlArgString)\x0a" + (Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\x0a")(v.imports) + ("\x0a\x0adata " + (v.name + (" \x0a  = " + (enumCtrs + ("\x0a\x0a" + (v.customCode({
              name: v.name,
              values: v.values
          }) + ("\x0a\x0ainstance eq" + (v.name + (" :: Eq " + (v.name + (" where \x0a  eq = eq `on` show\x0a\x0ainstance ord" + (v.name + (" :: Ord " + (v.name + (" where\x0a  compare = compare `on` show\x0a\x0ainstance argToGql" + (v.name + (" :: ArgGql " + (v.name + (" " + (v.name + ("\x0a\x0ainstance gqlArgString" + (v.name + (" :: GqlArgString " + (v.name + (" where\x0a  toGqlArgStringImpl = show\x0a\x0ainstance decodeJson" + (v.name + (" :: DecodeJson " + (v.name + (" where\x0a  decodeJson = decodeJson >=> case _ of \x0a" + (decodeMember + ("\x0a    s -> Left $ TypeMismatch $ \"Not a " + (v.name + (": \" <> s\x0a\x0ainstance encodeJson" + (v.name + (" :: EncodeJson " + (v.name + (" where \x0a  encodeJson = show >>> encodeJson\x0a\x0ainstance show" + (v.name + (" :: Show " + (v.name + (" where\x0a  show a = case a of \x0a" + (showMember + "\x0a")))))))))))))))))))))))))))))))))))))))))))))));
      };
  };
...
(function($PS) {
  ...
  var prependLines = function (pre) {
      var $175 = Data_Functor.map(Data_Functor.functorArray)(function (l) {
          var $46 = l === "";
          if ($46) {
              return l;
          };
      ...
      return function ($176) {
          return fromLines($175(toLines($176)));
      };
  };
  ...
  var gqlToPursEnums = (function () {
      ...
      var definitionToPurs = function (v) {
          ...
          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 417, column 22 - line 420, column 54): " + [ v.constructor.name ]);
      };
      ...
      var $178 = Data_List.mapMaybe(definitionToEnum);
      var $179 = Data_Newtype.unwrap(Data_GraphQL_AST.documentNewtype);
      return function ($180) {
  ...
  var gqlToPursMainSchemaCode = function (v) {
      return function (doc) {
          ...
          var namedTypeToPursNullable = function ($181) {
              return wrapMaybe(namedTypeToPurs($181));
          };
          var typeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 385, column 16 - line 388, column 72): " + [ v1.constructor.name ]);
          };
          var notNullTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 399, column 23 - line 401, column 51): " + [ v1.constructor.name ]);
          };
          ...
          var removeDuplicateDefinitions = (function () {
              var $182 = Data_List.fromFoldable(Data_Foldable.foldableArray);
              var $183 = Data_Array.nubBy(Data_Function.on(Data_Ord.compare(Data_Ord.ordString))(getDefinitionTypeName));
              var $184 = Data_Array.fromFoldable(Data_List_Types.foldableList);
              return function ($185) {
          ...
          var scalarTypeDefinitionToPurs = function (v1) {
              ...
              return Data_Monoid.guard(Data_Monoid.monoidString)(Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(tName)(builtInTypes))(descriptionToDocComment(v1.description) + ("type " + (tName + (" = " + (typeAndModule.moduleName + ("." + typeAndModule.typeName))))));
          };
          var argTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 369, column 19 - line 372, column 89): " + [ v1.constructor.name ]);
          };
          var argNotNullTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 375, column 26 - line 377, column 54): " + [ v1.constructor.name ]);
          };
          ...
          var inputValueDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return descriptionToDocComment(v1.description) + (v1.name + (" :: " + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 358, column 10 - line 363, column 55): " + [ v2.constructor.name ]);
                  })()));
              };
          };
          ...
          var fieldDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return descriptionToDocComment(v1.description) + (v1.name + (" :: " + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(argumentsDefinitionToPurs)(v1.argumentsDefinition) + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 269, column 10 - line 274, column 67): " + [ v2.constructor.name ]);
                  })())));
              };
          };
  ...
  var schemaFromGqlToPursWithCache = function (opts) {
      return function (v) {
          var go = function (v1) {
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(v1.value0.get(v.schema))(function (jsonMay) {
                      return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                          var v2 = Control_Bind.bind(Data_Maybe.bindMaybe)(jsonMay)((function () {
                              ...
                              return function ($187) {
                                  return Data_Either.hush($186($187));
                              };
                          })());
                          if (v2 instanceof Data_Maybe.Nothing) {
                          ...
                          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 98, column 13 - line 100, column 35): " + [ v2.constructor.name ]);
                      })())(function (eVal) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 94, column 3 - line 94, column 70): " + [ v1.constructor.name ]);
          };
  ...
  var schemasFromGqlToPurs = function (opts_) {
      ...
      var $188 = Data_Functor.map(Effect_Aff.functorAff)(Data_Functor.map(Data_Either.functorEither)(collectSchemas));
      var $189 = Data_Functor.map(Effect_Aff.functorAff)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither));
      var $190 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect_Aff.applicativeAff)(schemaFromGqlToPursWithCache(opts));
      return function ($191) {
  ...
  var schemasFromGqlToPursJs = (function () {
      var go = function (optsJs) {
          var opts = {
              ...
              customEnumCode: defNull(Data_Function["const"](""))(optsJs.customEnumCode),
