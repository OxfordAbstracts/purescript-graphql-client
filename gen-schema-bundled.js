...
(function($PS) {
  ...
  var gqlToPursEnums = (function () {
      ...
      var definitionToPurs = function (v) {
          ...
          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 423, column 22 - line 426, column 54): " + [ v.constructor.name ]);
      };
      ...
      return function (doc) {
          ...
          var rootOperationTypeDefinitionToPurs = function (v1) {
              var opStr = (function () {
                  ...
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 181, column 13 - line 184, column 41): " + [ v1.operationType.constructor.name ]);
              })();
          ...
          var typeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 393, column 16 - line 396, column 72): " + [ v1.constructor.name ]);
          };
          var notNullTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 407, column 23 - line 409, column 51): " + [ v1.constructor.name ]);
          };
          ...
          var scalarTypeDefinitionToPurs = function (v1) {
              ...
              return Data_Monoid.guard(Data_Monoid.monoidString)(Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(tName)(builtInTypes))((function () {
                  ...
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 197, column 40 - line 214, column 31): " + [ v2.constructor.name ]);
              })());
          };
          var argTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 377, column 19 - line 380, column 89): " + [ v1.constructor.name ]);
          };
          var argNotNullTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 383, column 26 - line 385, column 54): " + [ v1.constructor.name ]);
          };
          ...
          var inputValueDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return descriptionToDocComment(v1.description) + (v1.name + (" :: " + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 369, column 10 - line 371, column 60): " + [ v2.constructor.name ]);
                  })()));
              };
          };
          ...
          var fieldDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return descriptionToDocComment(v1.description) + (v1.name + (" :: " + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(argumentsDefinitionToPurs)(v1.argumentsDefinition) + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 281, column 10 - line 283, column 60): " + [ v2.constructor.name ]);
                  })())));
              };
          };
          ...
          var typeDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 187, column 26 - line 193, column 143): " + [ v1.constructor.name ]);
          };
          var typeSystemDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 166, column 32 - line 169, column 118): " + [ v1.constructor.name ]);
          };
          var definitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 160, column 22 - line 163, column 54): " + [ v1.constructor.name ]);
          };
  ...
  var schemaFromGqlToPursWithCache = function (opts) {
      return function (v) {
          var go = function (v1) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(v1.value0.get(v.schema))(function (jsonMay) {
                      return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                          ...
                          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 101, column 13 - line 103, column 35): " + [ v2.constructor.name ]);
                      })())(function (eVal) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 97, column 3 - line 97, column 70): " + [ v1.constructor.name ]);
          };
