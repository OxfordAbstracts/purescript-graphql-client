...
(function($PS) {
      ...
      return function (doc) {
          ...
          var rootOperationTypeDefinitionToPurs = function (v1) {
              var opStr = (function () {
                  ...
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 184, column 13 - line 187, column 41): " + [ v1.operationType.constructor.name ]);
              })();
          ...
          var namedTypeToPursNullable = function ($175) {
              return wrapMaybe(namedTypeToPurs($175));
          };
          ...
          var removeDuplicateDefinitions = (function () {
              var $176 = Data_List.fromFoldable(Data_Foldable.foldableArray);
              var $177 = Data_Array.nubBy(Data_Function.on(Data_Ord.compare(Data_Ord.ordString))(getDefinitionTypeName));
              var $178 = Data_Array.fromFoldable(Data_List_Types.foldableList);
              return function ($179) {
          ...
          var scalarTypeDefinitionToPurs = function (v1) {
              ...
              return Data_Monoid.guard(Data_Monoid.monoidString)(Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(tName)(builtInTypes))(GraphQL_Client_CodeGen_Lines.docComment(Data_Foldable.foldableMaybe)(v1.description) + ("type " + (tName + (" = " + (typeAndModule.moduleName + ("." + typeAndModule.typeName))))));
          };
          ...
          var fieldDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return inlineComment(v1.description) + (v1.name + (" :: " + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(argumentsDefinitionToPurs)(v1.argumentsDefinition) + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 274, column 10 - line 279, column 67): " + [ v2.constructor.name ]);
                  })())));
              };
          };
          ...
          var typeDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 190, column 26 - line 196, column 143): " + [ v1.constructor.name ]);
          };
          var typeSystemDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 169, column 32 - line 172, column 118): " + [ v1.constructor.name ]);
          };
          var definitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 163, column 22 - line 166, column 54): " + [ v1.constructor.name ]);
          };
  ...
  var gqlToPursEnums = (function () {
      var enumValuesDefinitionToPurs = function (def) {
          return Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Functor.mapFlipped(Data_List_Types.functorList)(Data_Newtype.unwrap(Data_GraphQL_AST.enumValuesDefinitionNewtype)(def))(function (v) {
              return inlineComment(v.description) + Data_Newtype.unwrap(Data_GraphQL_AST.enumValueNewtype)(v.enumValue);
          }));
      };
      ...
      var definitionToPurs = function (v) {
          ...
          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 422, column 22 - line 425, column 54): " + [ v.constructor.name ]);
      };
      ...
      var $180 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      var $181 = Data_List.mapMaybe(definitionToEnum);
      var $182 = Data_Newtype.unwrap(Data_GraphQL_AST.documentNewtype);
      return function ($183) {
  ...
  var schemaFromGqlToPursWithCache = function (opts) {
      return function (v) {
          var go = function (v1) {
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(v1.value0.get(v.schema))(function (jsonMay) {
                      return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                          var v2 = Control_Bind.bind(Data_Maybe.bindMaybe)(jsonMay)((function () {
                              ...
                              return function ($185) {
                                  return Data_Either.hush($184($185));
                              };
                          })());
                          if (v2 instanceof Data_Maybe.Nothing) {
                          ...
                          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 103, column 13 - line 105, column 35): " + [ v2.constructor.name ]);
                      })())(function (eVal) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 99, column 3 - line 99, column 70): " + [ v1.constructor.name ]);
          };
  ...
  var schemasFromGqlToPurs = function (opts_) {
      ...
      var $186 = Data_Functor.map(Effect_Aff.functorAff)(Data_Functor.map(Data_Either.functorEither)(collectSchemas));
      var $187 = Data_Functor.map(Effect_Aff.functorAff)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither));
      var $188 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect_Aff.applicativeAff)(schemaFromGqlToPursWithCache(opts));
      return function ($189) {
          return $186($187($188($189)));
      };
  };
