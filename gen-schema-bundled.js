...
(function($PS) {
      ...
      return function (doc) {
          ...
          var rootOperationTypeDefinitionToPurs = function (v1) {
              var opStr = (function () {
                  ...
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 190, column 13 - line 193, column 41): " + [ v1.operationType.constructor.name ]);
              })();
          ...
          var typeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 388, column 16 - line 391, column 72): " + [ v1.constructor.name ]);
          };
          var notNullTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 402, column 23 - line 404, column 51): " + [ v1.constructor.name ]);
          };
          ...
          var getDefinitionTypeName = (function () {
              var $161 = Data_Array.filter(function (l) {
              ...
              var $162 = Data_String_CodePoints.takeWhile(Data_Eq.notEq(Data_String_CodePoints.eqCodePoint)(Data_String_CodePoints.codePointFromChar("=")));
              return function ($163) {
                  return GraphQL_Client_CodeGen_Lines.fromLines($161(GraphQL_Client_CodeGen_Lines.toLines($162($163))));
              };
          })();
          var removeDuplicateDefinitions = (function () {
              var $164 = Data_List.fromFoldable(Data_Foldable.foldableArray);
              var $165 = Data_Array.nubBy(Data_Function.on(Data_Ord.compare(Data_Ord.ordString))(getDefinitionTypeName));
              var $166 = Data_Array.fromFoldable(Data_List_Types.foldableList);
              return function ($167) {
          ...
          var argTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 372, column 19 - line 375, column 89): " + [ v1.constructor.name ]);
          };
          var argNotNullTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 378, column 26 - line 380, column 54): " + [ v1.constructor.name ]);
          };
          ...
          var inputValueDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return inlineComment(v1.description) + (v1.name + (" :: " + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 361, column 10 - line 366, column 55): " + [ v2.constructor.name ]);
                  })()));
              };
          };
          ...
          var fieldDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return inlineComment(v1.description) + (v1.name + (" :: " + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(argumentsDefinitionToPurs)(v1.argumentsDefinition) + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 277, column 10 - line 282, column 67): " + [ v2.constructor.name ]);
                  })())));
              };
          };
          ...
          var typeDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 196, column 26 - line 202, column 143): " + [ v1.constructor.name ]);
          };
          var typeSystemDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 175, column 32 - line 178, column 118): " + [ v1.constructor.name ]);
          };
          var definitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 169, column 22 - line 172, column 52): " + [ v1.constructor.name ]);
          };
  ...
  var gqlToPursEnums = (function () {
      ...
      var $168 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      var $169 = Data_List.mapMaybe(definitionToEnum);
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(v1.value0.get(v.schema))(function (jsonMay) {
                      return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                          var v2 = Control_Bind.bind(Data_Maybe.bindMaybe)(jsonMay)((function () {
                              ...
                              return function ($173) {
                                  return Data_Either.hush($172($173));
                              };
                          })());
                          if (v2 instanceof Data_Maybe.Nothing) {
  ...
  var schemasFromGqlToPurs = function (opts_) {
      ...
      var $174 = Data_Functor.map(Effect_Aff.functorAff)(Data_Functor.map(Data_Either.functorEither)(collectSchemas));
      var $175 = Data_Functor.map(Effect_Aff.functorAff)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither));
      var $176 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect_Aff.applicativeAff)(schemaFromGqlToPursWithCache(opts));
      return function ($177) {
