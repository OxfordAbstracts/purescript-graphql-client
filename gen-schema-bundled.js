...
(function($PS) {
  // Generated by purs version 0.14.3
  "use strict";
  $PS["GraphQL.Client.CodeGen.Util"] = $PS["GraphQL.Client.CodeGen.Util"] || {};
  var exports = $PS["GraphQL.Client.CodeGen.Util"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_GraphQL_AST = $PS["Data.GraphQL.AST"];
  var Data_List_Types = $PS["Data.List.Types"];
  ...
  var argNotNullTypeToPurs = function (gqlScalarsToPursTypes) {
      return function (v) {
          if (v instanceof Data_GraphQL_AST.NonNullType_NamedType) {
              return namedTypeToPurs(gqlScalarsToPursTypes)(v.value0);
          };
...
(function($PS) {
  ...
  "use strict";
  $PS["GraphQL.Client.CodeGen.Directive"] = $PS["GraphQL.Client.CodeGen.Directive"] || {};
  var exports = $PS["GraphQL.Client.CodeGen.Directive"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var getDirectiveDefinitions = function (defs) {
      return Control_Bind.bind(Data_List_Types.bindList)(defs)(function (v) {
          if (v instanceof Data_GraphQL_AST.Definition_TypeSystemDefinition && v.value0 instanceof Data_GraphQL_AST.TypeSystemDefinition_DirectiveDefinition) {
              return Control_Applicative.pure(Data_List_Types.applicativeList)(v.value0.value0);
          };
  ...
  var executableDirectiveLocationtoPurs = function (v) {
      if (v instanceof Data_GraphQL_AST.QUERY) {
          return new Data_Maybe.Just("QUERY");
      };
      if (v instanceof Data_GraphQL_AST.MUTATION) {
          return new Data_Maybe.Just("MUTATION");
      };
      if (v instanceof Data_GraphQL_AST.SUBSCRIPTION) {
          return new Data_Maybe.Just("SUBSCRIPTION");
      };
      if (v instanceof Data_GraphQL_AST.FIELD) {
          return Data_Maybe.Nothing.value;
      };
      if (v instanceof Data_GraphQL_AST.FRAGMENT_DEFINITION) {
          return Data_Maybe.Nothing.value;
      };
      if (v instanceof Data_GraphQL_AST.FRAGMENT_SPREAD) {
          return Data_Maybe.Nothing.value;
      };
  ...
  var directiveLocationsToPurs = function (v) {
      return Data_List.mapMaybe(directiveLocationToPurs)(v);
  };
  var directiveToPurs = function (gqlScalarsToPursTypes) {
      return function (v) {
          var locations = directiveLocationsToPurs(v.directiveLocations);
          var locationsStr = Data_Foldable.fold(Data_List_Types.foldableList)(Data_Monoid.monoidString)(locations);
          var $20 = Data_Foldable["null"](Data_List_Types.foldableList)(locations);
          if ($20) {
              return "";
          };
          ...
          })(v.argumentsDefinition) + (" (" + (locationsStr + "Nil')\x0a  :> ")))))));
      };
  };
...
(function($PS) {
  ...
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  var GraphQL_Client_CodeGen_Directive = $PS["GraphQL.Client.CodeGen.Directive"];
  ...
  var gqlToPursMainSchemaCode = function (v) {
      return function (doc) {
          ...
          var typeName_ = GraphQL_Client_CodeGen_Util.typeName(v.gqlScalarsToPursTypes);
          var namedTypeToPurs_ = GraphQL_Client_CodeGen_Util.namedTypeToPurs(v.gqlScalarsToPursTypes);
          ...
          var namedTypeToPursNullable = function ($139) {
              return wrapMaybe(namedTypeToPurs_($139));
          };
          var typeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 360, column 16 - line 363, column 72): " + [ v1.constructor.name ]);
          };
          var notNullTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 374, column 23 - line 376, column 51): " + [ v1.constructor.name ]);
          };
          ...
          var inputValueDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return GraphQL_Client_CodeGen_Util.inlineComment(v1.description) + (v1.name + (" :: " + (function () {
                      ...
                      if (v2 instanceof Data_Maybe.Nothing) {
                          return GraphQL_Client_CodeGen_Util.argTypeToPurs(v.gqlScalarsToPursTypes)(v1.type);
                      };
                      if (v2 instanceof Data_Maybe.Just) {
                          if (v1.type instanceof Data_GraphQL_AST.Type_NonNullType) {
                              return GraphQL_Client_CodeGen_Util.wrapNotNull(v2.value0.moduleName + ("." + v2.value0.typeName));
                          };
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 349, column 10 - line 354, column 55): " + [ v2.constructor.name ]);
                  })()));
              };
          };
          ...
          var getDefinitionTypeName = (function () {
              var $140 = Data_Array.filter(function (l) {
              ...
              var $141 = Data_String_CodePoints.takeWhile(Data_Eq.notEq(Data_String_CodePoints.eqCodePoint)(Data_String_CodePoints.codePointFromChar("=")));
              return function ($142) {
                  return GraphQL_Client_CodeGen_Lines.fromLines($140(GraphQL_Client_CodeGen_Lines.toLines($141($142))));
              };
          })();
          var removeDuplicateDefinitions = (function () {
              var $143 = Data_List.fromFoldable(Data_Foldable.foldableArray);
              var $144 = Data_Array.nubBy(Data_Function.on(Data_Ord.compare(Data_Ord.ordString))(getDefinitionTypeName));
              var $145 = Data_Array.fromFoldable(Data_List_Types.foldableList);
              return function ($146) {
          ...
          var fieldDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return GraphQL_Client_CodeGen_Util.inlineComment(v1.description) + (v1.name + (" :: " + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(GraphQL_Client_CodeGen_Util.argumentsDefinitionToPurs(v.gqlScalarsToPursTypes))(v1.argumentsDefinition) + (function () {
                      var v2 = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(objectName)(v.fieldTypeOverrides))(Data_Map_Internal.lookup(Data_Ord.ordString)(v1.name));
                      if (v2 instanceof Data_Maybe.Nothing) {
  ...
  var gqlToPursEnums = function (gqlScalarsToPursTypes) {
      var typeName_ = GraphQL_Client_CodeGen_Util.typeName(gqlScalarsToPursTypes);
      ...
      var $147 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      var $148 = Data_List.mapMaybe(definitionToEnum);
      ...
      return function (v) {
          return Data_Functor.mapFlipped(Data_Either.functorEither)(Text_Parsing_Parser.runParser(v.schema)(Data_GraphQL_Parser.document(Text_Parsing_Parser_String.stringLikeString)))(function (ast) {
              ...
              return {
                  ...
                  directives: GraphQL_Client_CodeGen_Directive.getDocumentDirectivesPurs(opts.gqlScalarsToPursTypes)(ast),
                  symbols: symbols,
  ...
  var schemaFromGqlToPursWithCache = function (opts) {
      return function (v) {
          var go = function (v1) {
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(v1.value0.get(v.schema))(function (jsonMay) {
                      return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                          var v2 = Control_Bind.bind(Data_Maybe.bindMaybe)(jsonMay)((function () {
                              ...
                              return function ($152) {
                                  return Data_Either.hush($151($152));
                              };
                          })());
                          if (v2 instanceof Data_Maybe.Nothing) {
                          ...
                          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 111, column 13 - line 113, column 35): " + [ v2.constructor.name ]);
                      })())(function (eVal) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
                              if (eVal instanceof Data_Either.Right) {
                                  return v1.value0.set({
                                      key: v.schema,
                                      val: Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                                          return "values";
                                      }))())(new Data_Symbol.IsSymbol(function () {
                                          return "name";
                                      }))())(new Data_Symbol.IsSymbol(function () {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 107, column 3 - line 107, column 70): " + [ v1.constructor.name ]);
          };
      ...
      var collectSchemas = function (pursGqls) {
          return {
              ...
              directives: Data_Functor.mapFlipped(Data_Functor.functorArray)(pursGqls)(function (pg) {
                  return {
                      code: "module " + (modulePrefix + ("Directives." + (pg.moduleName + (" where\x0a" + pg.directives)))),
                      path: opts.dir + ("/Directives/" + (pg.moduleName + ".purs"))
                  };
              })
          };
      };
      var $153 = Data_Functor.map(Effect_Aff.functorAff)(Data_Functor.map(Data_Either.functorEither)(collectSchemas));
      var $154 = Data_Functor.map(Effect_Aff.functorAff)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither));
      var $155 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect_Aff.applicativeAff)(schemaFromGqlToPursWithCache(opts));
      return function ($156) {
          return $153($154($155($156)));
      };
  };
