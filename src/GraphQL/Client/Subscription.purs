...
subscriptionOpts ::
  ...
  DecodeJson returns =>
  (opts -> opts) -> Client client directives a b schema -> String -> query -> Emitter (Either JsonDecodeError returns)
...
subscription ::
  ...
  GqlQuery directives OpSubscription schema query returns =>
  DecodeJson returns =>
  Client client directives a b schema -> String -> query -> Emitter (Either JsonDecodeError returns)
