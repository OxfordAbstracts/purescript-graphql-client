...
(function($PS) {
  ...
  var gqlToPursMainSchemaCode = function (v) {
      return function (doc) {
          ...
          var namedTypeToPursNullable = function ($161) {
              return wrapMaybe(namedTypeToPurs($161));
          };
          ...
          var removeDuplicateDefinitions = (function () {
              var $162 = Data_List.fromFoldable(Data_Foldable.foldableArray);
              var $163 = Data_Array.nubBy(Data_Function.on(Data_Ord.compare(Data_Ord.ordString))(getDefinitionTypeName));
              var $164 = Data_Array.fromFoldable(Data_List_Types.foldableList);
              return function ($165) {
                  return $162($163($164($165)));
              };
          })();
  ...
  var gqlToPursEnums = (function () {
      var enumValuesDefinitionToPurs = function (def) {
          return Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Functor.mapFlipped(Data_List_Types.functorList)(Data_Newtype.unwrap()(def))(function (v) {
              return inlineComment(v.description) + Data_Newtype.unwrap()(v.enumValue);
          }));
      };
      ...
      var $167 = Data_List.mapMaybe(definitionToEnum);
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(v1.value0.get(v.schema))(function (jsonMay) {
                      return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                          var v2 = Control_Bind.bind(Data_Maybe.bindMaybe)(jsonMay)((function () {
                              ...
                              return function ($171) {
                                  return Data_Either.hush($170($171));
                              };
                          })());
                          if (v2 instanceof Data_Maybe.Nothing) {
  ...
  var schemasFromGqlToPurs = function (opts_) {
      ...
      var $172 = Data_Functor.map(Effect_Aff.functorAff)(Data_Functor.map(Data_Either.functorEither)(collectSchemas));
      var $173 = Data_Functor.map(Effect_Aff.functorAff)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither));
      var $174 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect_Aff.applicativeAff)(schemaFromGqlToPursWithCache(opts));
      return function ($175) {
