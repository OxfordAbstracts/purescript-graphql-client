...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Foreign.Generic.Internal"] = $PS["Foreign.Generic.Internal"] || {};
  var exports = $PS["Foreign.Generic.Internal"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Identity = $PS["Data.Identity"];
...
(function($PS) {
  ...
  var Data_Traversable = $PS["Data.Traversable"];
  var Foreign = $PS["Foreign"];
  var Foreign_Generic_Internal = $PS["Foreign.Generic.Internal"];
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["MasonPrelude"] = $PS["MasonPrelude"] || {};
  var exports = $PS["MasonPrelude"];
  var Data_String_CodeUnits = $PS["Data.String.CodeUnits"];                
  var fromChar = Data_String_CodeUnits.singleton;
...
(function($PS) {
  ...
  "use strict";
  $PS["Return"] = $PS["Return"] || {};
  var exports = $PS["Return"];
  var $foreign = $PS["Return"];          
  var Cont = (function () {
      function Cont(value0) {
          this.value0 = value0;
      };
      Cont.create = function (value0) {
          return new Cont(value0);
      };
      return Cont;
  })();
  var Return = (function () {
  ...
  var unsafeThrow = function (ra) {
      return $foreign.unsafeThrowImpl((function () {
          if (ra instanceof Cont) {
              return false;
          };
          if (ra instanceof Return) {
              return true;
          };
          throw new Error("Failed pattern match at Return (line 15, column 7 - line 17, column 25): " + [ ra.constructor.name ]);
      })())((function () {
          if (ra instanceof Cont) {
              return ra.value0;
          };
          ...
          throw new Error("Failed pattern match at Return (line 19, column 7 - line 21, column 22): " + [ ra.constructor.name ]);
      })());
  };
  var mkReturnable = $foreign.mkReturnableImpl(unsafeThrow);
  exports["Cont"] = Cont;
  exports["Return"] = Return;
  exports["mkReturnable"] = mkReturnable;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Return.Folds"] = $PS["Return.Folds"] || {};
  var exports = $PS["Return.Folds"];
  var Data_Foldable = $PS["Data.Foldable"];
  var PointFree = $PS["PointFree"];
  var Return = $PS["Return"];
  var foldl = function (dictFoldable) {
      return function (f) {
          return function (init) {
              return function (as) {
                  return Return.mkReturnable(function ($$return) {
                      return Data_Foldable.foldl(dictFoldable)(PointFree.compose2($$return)(f))(init)(as);
                  });
              };
          };
      };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Substitute"] = $PS["Substitute"] || {};
  var exports = $PS["Substitute"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Category = $PS["Control.Category"];
  var Data_Array = $PS["Data.Array"];
  var Data_Array_NonEmpty = $PS["Data.Array.NonEmpty"];
  ...
  var Data_Tuple = $PS["Data.Tuple"];
  var Foreign_Object = $PS["Foreign.Object"];
  var MasonPrelude = $PS["MasonPrelude"];
  var Return = $PS["Return"];
  var Return_Folds = $PS["Return.Folds"];                
  var CountingSpaces = (function () {
      function CountingSpaces(value0) {
          this.value0 = value0;
      };
      CountingSpaces.create = function (value0) {
          return new CountingSpaces(value0);
      };
      return CountingSpaces;
  })();
  var EnteringTemplate = (function () {
      function EnteringTemplate() {

      };
      EnteringTemplate.value = new EnteringTemplate();
      return EnteringTemplate;
  })();
  var GettingKey = (function () {
      function GettingKey(value0) {
          this.value0 = value0;
      };
      GettingKey.create = function (value0) {
          return new GettingKey(value0);
      };
      return GettingKey;
  })();
  var Continuing = (function () {
      ...
      Continuing.value = new Continuing();
      return Continuing;
  })();
  var Skipping = (function () {
      ...
      Skipping.value = new Skipping();
      return Skipping;
  })();
  var unsnocString = function (s) {
      var lengthm1 = Data_String_CodePoints.length(s) - 1 | 0;
      return Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_String_CodeUnits.charAt(lengthm1)(s))(function (v) {
          return {
              last: v,
              init: Data_String_CodePoints.take(lengthm1)(s)
          };
      });
  };
  var toLines = (function () {
      var $82 = Data_Maybe.fromMaybe(Control_Applicative.pure(Data_Array_NonEmpty_Internal.applicativeNonEmptyArray)(""));
      var $83 = Data_String_Common.split("\x0a");
      return function ($84) {
          return $82(Data_Array_NonEmpty.fromArray($83($84)));
      };
  })();
  var rep = function (n) {
      return function (s) {
          ...
          throw new Error("Failed pattern match at Substitute (line 320, column 1 - line 320, column 31): " + [ n.constructor.name, s.constructor.name ]);
      };
  };
  var normalize = function (str) {
      return (function (lines) {
          var blankLineRemoved = (function (v) {
              var $30 = Data_String_CodeUnits.countPrefix(Data_Eq.eq(Data_Eq.eqChar)(" "))(v.last) === Data_String_CodePoints.length(v.last);
              if ($30) {
                  var $31 = Data_Array["null"](v.init);
                  if ($31) {
                      return [ "" ];
                  };
                  return v.init;
              };
              return Data_Array_NonEmpty.toArray(lines);
          })(Data_Array_NonEmpty.unsnoc(lines));
          var minSpaces = Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
              return function (line) {
                  ...
                  return (function () {
                      ...
                      return Data_Ord.min(Data_Ord.ordInt)(acc);
                  })()(Data_String_CodeUnits.countPrefix(Data_Eq.eq(Data_Eq.eqChar)(" "))(line));
              };
          })(-1 | 0)(blankLineRemoved);
          return (function (v) {
              var $41 = Data_Array_NonEmpty.length(lines) === Data_Array.length(blankLineRemoved);
              if ($41) {
                  return v.value0;
              };
              return v.value0 + "\x0a";
              ...
              return function (line) {
                  return new Data_Tuple.Tuple((function () {
                      ...
                      return function (l) {
                          return v.value0 + ("\x0a" + l);
                      };
                  })()(Data_String_CodePoints.drop(minSpaces)(line)), false);
              };
          })(new Data_Tuple.Tuple("", true))(blankLineRemoved));
      })(toLines((function () {
          var $28 = Data_String_CodePoints.take(1)(str) === "\x0a";
          if ($28) {
              return Data_String_CodePoints.drop(1)(str);
          };
          return str;
      })()));
  };
  ...
  var createSubstituter = function (dictHomogeneous) {
      return function (v) {
          return function (templateStr) {
              return function (subsRec) {
                  var subs = Foreign_Object.fromHomogeneous()(subsRec);
                  var chars = Data_String_CodeUnits.toCharArray((function () {
                      if (v.normalizeString) {
                          return normalize(templateStr);
                      };
                      return templateStr;
                  })());
                  return Data_Tuple.snd(Return_Folds.foldl(Data_Foldable.foldableArray)(function (v1) {
                      return function ($$char) {
                          var charS = MasonPrelude.fromChar($$char);
                          if ($$char === "\x0a") {
                              return Return.Cont.create(new Data_Tuple.Tuple({
                                  state: new CountingSpaces(0),
                                  leadingSpaces: v1.value0.leadingSpaces
                              }, v1.value1 + charS));
                          };
                          if (v1.value0.state instanceof Continuing && $$char === "\\") {
                              return Return.Cont.create(new Data_Tuple.Tuple({
                                  state: Skipping.value,
                                  leadingSpaces: v1.value0.leadingSpaces
                              }, v1.value1 + charS));
                          };
                          if (v1.value0.state instanceof Continuing) {
                              var $51 = $$char === v.marker;
                              if ($51) {
                                  return Return.Cont.create(new Data_Tuple.Tuple({
                                      leadingSpaces: 0,
                                      state: EnteringTemplate.value
                                  }, v1.value1 + charS));
                              };
                              return Return.Cont.create(new Data_Tuple.Tuple({
                          ...
                          if (v1.value0.state instanceof CountingSpaces && $$char === " ") {
                              return Return.Cont.create(new Data_Tuple.Tuple({
                                  state: CountingSpaces.create(v1.value0.state.value0 + 1 | 0),
                                  leadingSpaces: v1.value0.leadingSpaces
                              }, v1.value1 + charS));
                          };
                          if (v1.value0.state instanceof CountingSpaces && $$char === "\\") {
                              return Return.Cont.create(new Data_Tuple.Tuple({
                                  leadingSpaces: v1.value0.state.value0,
                                  state: Skipping.value
                              }, v1.value1 + charS));
                          };
                          if (v1.value0.state instanceof CountingSpaces) {
                              var $54 = $$char === v.marker;
                              if ($54) {
                                  return Return.Cont.create(new Data_Tuple.Tuple({
                                      leadingSpaces: v1.value0.state.value0,
                                      state: EnteringTemplate.value
                          ...
                          if (v1.value0.state instanceof EnteringTemplate) {
                              var $56 = $$char === v.open;
                              if ($56) {
                                  return Return.Cont.create(new Data_Tuple.Tuple({
                                      state: new GettingKey(""),
                                      leadingSpaces: v1.value0.leadingSpaces
                                  }, Data_String_CodeUnits.dropRight(1)(v1.value1)));
                              };
                              return Return.Cont.create(new Data_Tuple.Tuple({
                                  state: Continuing.value,
                                  leadingSpaces: v1.value0.leadingSpaces
                          ...
                          if (v1.value0.state instanceof GettingKey) {
                              var $57 = $$char === v.close;
                              if ($57) {
                                  var v2 = Foreign_Object.lookup(v1.value0.state.value0)(subs);
                                  if (v2 instanceof Data_Maybe.Just) {
                                      return Return.Cont.create(new Data_Tuple.Tuple({
                                          ...
                                          if (v.indent) {
                                              return (function (lines) {
                                                  var v4 = Data_Array_NonEmpty.uncons(lines);
                                                  return v4.head + Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
                                                      return function (line) {
                                                          return acc + ("\x0a" + ((function () {
                                                              var $66 = line === "";
                                                              if ($66) {
                                                                  return "";
                                                              };
                                                              return rep(v1.value0.leadingSpaces)(" ");
                                                          })() + line));
                                                      };
                                                  })("")(v4.tail);
                                              })(toLines(v3));
                                          ...
                                          return Data_Maybe.maybe(v3)(function (v4) {
                                              var $61 = v4.last === "\x0a" && v.suppress;
                                              if ($61) {
                                                  return v4.init;
                                              };
                                              return v3;
                                          ...
                                          if (v.normalizeSubstitutions) {
                                              return normalize(v2.value0);
                                          };
                                          return Control_Category.identity(Control_Category.categoryFn)(v2.value0);
                                      })()))));
                                  };
                                  if (v2 instanceof Data_Maybe.Nothing) {
                                      return Return.Return.create(new Data_Tuple.Tuple(v1.value0, v.missing(v1.value0.state.value0)));
                                  };
                                  throw new Error("Failed pattern match at Substitute (line 251, column 39 - line 290, column 59): " + [ v2.constructor.name ]);
                              };
                              return Return.Cont.create(new Data_Tuple.Tuple({
                                  state: GettingKey.create(v1.value0.state.value0 + charS),
                                  leadingSpaces: v1.value0.leadingSpaces
                              }, v1.value1));
                          };
                          if (v1.value0.state instanceof Skipping && $$char === "\\") {
                              return Return.Cont.create(new Data_Tuple.Tuple({
                                  state: Skipping.value,
                                  leadingSpaces: v1.value0.leadingSpaces
                              }, v1.value1 + charS));
                          };
                          if (v1.value0.state instanceof Skipping) {
                              var $71 = $$char === v.marker;
                              if ($71) {
                                  return Return.Cont.create(new Data_Tuple.Tuple({
                                      state: Continuing.value,
                                      leadingSpaces: v1.value0.leadingSpaces
                                  }, Data_String_CodeUnits.dropRight(1)(v1.value1) + charS));
                              };
                              return Return.Cont.create(new Data_Tuple.Tuple({
                                  state: Continuing.value,
                                  leadingSpaces: v1.value0.leadingSpaces
                          ...
                          throw new Error("Failed pattern match at Substitute (line 230, column 13 - line 298, column 72): " + [ v1.value0.state.constructor.name, $$char.constructor.name ]);
                      };
  ...
  var substitute = function (dictHomogeneous) {
      return createSubstituter()(defaultOptions);
  };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["GraphQL.Client.CodeGen.Enum"] = $PS["GraphQL.Client.CodeGen.Enum"] || {};
  var exports = $PS["GraphQL.Client.CodeGen.Enum"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Monoid = $PS["Data.Monoid"];
  var Substitute = $PS["Substitute"];                
      ...
      return function (v) {
          var substVals = {
              ...
              decodeMember: Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\x0a")(Data_Functor.mapFlipped(Data_Functor.functorArray)(v.values)(function (v1) {
                  return Substitute.substitute()("\"${v}\" -> pure ${v}")({
                      v: v1
                  });
              })),
              showMember: Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\x0a")(Data_Functor.mapFlipped(Data_Functor.functorArray)(v.values)(function (v1) {
                  return Substitute.substitute()("${v} -> \"${v}\"")({
                      v: v1
                  });
              }))
          };
          return Substitute.substitute()("module ${modulePrefix}Enum.${name} where\x0a\x0aimport Prelude\x0a\x0aimport Foreign.Generic.Class (class Decode, decode)\x0aimport Data.Function (on)\x0aimport Data.String.Extra (snakeCase)\x0aimport Foreign (ForeignError(..), fail)\x0aimport GraphQL.Client.Args (class ArgGql)\x0aimport GraphQL.Client.ToGqlString (class GqlArgString)\x0a\x0adata ${name} \x0a  = ${enumCtrs}\x0a\x0ainstance eq${name} :: Eq ${name} where \x0a  eq = eq `on` show\x0a\x0ainstance ord${name} :: Ord ${name} where\x0a  compare = compare `on` show\x0a\x0ainstance argToGql${name} :: ArgGql ${name} ${name}\x0a\x0ainstance gqlArgString${name} :: GqlArgString ${name} where\x0a  toGqlArgStringImpl a = snakeCase (show a)\x0a\x0ainstance decode${name} :: Decode ${name} where\x0a  decode a = decode a >>= case _ of \x0a    ${decodeMember}\x0a    s -> fail $ ForeignError $ \"Not a ${name}: \" <> s\x0a\x0ainstance show${name} :: Show ${name} where\x0a  show a = case a of \x0a    ${showMember}\x0a")(substVals);
      };
  };
...
(function($PS) {
  ...
  var template = function (v) {
      var substVals = {
          ...
          mainSchemaCode: v.mainSchemaCode
      };
      return Substitute.substitute()("module ${modulePrefix}Schema.${name} where\x0a\x0aimport Data.Maybe (Maybe)\x0aimport Data.Newtype (class Newtype)\x0aimport GraphQL.Client.Args (class ArgGql, class RecordArg, type (==>), NotNull)\x0a${enumImports}\x0a\x0a${mainSchemaCode}\x0a")(substVals);
  };
  exports["template"] = template;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["GraphQL.Client.CodeGen.SchemaFromGqlToPurs"] = $PS["GraphQL.Client.CodeGen.SchemaFromGqlToPurs"] || {};
  var exports = $PS["GraphQL.Client.CodeGen.SchemaFromGqlToPurs"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except = $PS["Control.Monad.Except"];
  ...
  var Foreign_Object = $PS["Foreign.Object"];
  var GraphQL_Client_CodeGen_Enum = $PS["GraphQL.Client.CodeGen.Enum"];
  ...
  var prependLines = function (pre) {
      var $179 = Data_Functor.map(Data_Functor.functorArray)(function (l) {
          var $48 = l === "";
          if ($48) {
              return l;
          };
      ...
      return function ($180) {
          return fromLines($179(toLines($180)));
      };
  };
  ...
  var gqlToPursEnums = (function () {
      var enumValueToPurs = (function () {
          var $181 = Data_Newtype.unwrap(Data_GraphQL_AST.enumValueNewtype);
          return function ($182) {
              return typeName($181($182));
          };
      })();
      ...
      var definitionToPurs = function (v) {
          ...
          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 548, column 22 - line 551, column 54): " + [ v.constructor.name ]);
      };
      ...
      var $184 = Data_List.mapMaybe(definitionToEnum);
      var $185 = Data_Newtype.unwrap(Data_GraphQL_AST.documentNewtype);
      return function ($186) {
      ...
      return function (doc) {
          ...
          var rootOperationTypeDefinitionToPurs = function (v1) {
              var opStr = (function () {
                  ...
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 310, column 13 - line 313, column 41): " + [ v1.operationType.constructor.name ]);
              })();
          ...
          var namedTypeToPursNullable = function ($187) {
              return wrapMaybe(namedTypeToPurs($187));
          };
          var typeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 518, column 16 - line 521, column 72): " + [ v1.constructor.name ]);
          };
          var notNullTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 532, column 23 - line 534, column 51): " + [ v1.constructor.name ]);
          };
          ...
          var removeDuplicateDefinitions = (function () {
              var $188 = Data_List.fromFoldable(Data_Foldable.foldableArray);
              var $189 = Data_Array.nubBy(Data_Function.on(Data_Ord.compare(Data_Ord.ordString))(getDefinitionTypeName));
              var $190 = Data_Array.fromFoldable(Data_List_Types.foldableList);
              return function ($191) {
                  return $188($189($190($191)));
              };
          })();
          ...
          var scalarTypeDefinitionToPurs = function (v1) {
              ...
              return Data_Monoid.guard(Data_Monoid.monoidString)(Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(tName)(builtInTypes))((function () {
                  ...
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 327, column 7 - line 344, column 33): " + [ v2.constructor.name ]);
              })());
          };
          var argTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 502, column 19 - line 505, column 89): " + [ v1.constructor.name ]);
          };
          var argNotNullTypeToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 508, column 26 - line 510, column 54): " + [ v1.constructor.name ]);
          };
          ...
          var inputValueDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return descriptionToDocComment(v1.description) + (v1.name + (" :: " + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 494, column 10 - line 496, column 60): " + [ v2.constructor.name ]);
                  })()));
              };
          };
          ...
          var fieldDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return descriptionToDocComment(v1.description) + (v1.name + (" :: " + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(argumentsDefinitionToPurs)(v1.argumentsDefinition) + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 406, column 10 - line 408, column 60): " + [ v2.constructor.name ]);
                  })())));
              };
          };
          ...
          var objectTypeDefinitionToPurs = function (v1) {
              var tName = typeName(v1.name);
              return descriptionToDocComment(v1.description) + ("newtype " + (typeName(v1.name) + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function (fd) {
          ...
          var typeDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 316, column 26 - line 322, column 143): " + [ v1.constructor.name ]);
          };
          var typeSystemDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 295, column 32 - line 298, column 118): " + [ v1.constructor.name ]);
          };
          var definitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 289, column 22 - line 292, column 54): " + [ v1.constructor.name ]);
          };
  ...
  var schemaFromGqlToPurs = function (opts) {
      return function (v) {
          return Data_Functor.mapFlipped(Data_Either.functorEither)(Text_Parsing_Parser.runParser(v.gql)(Data_GraphQL_Parser.document(Text_Parsing_Parser_String.stringLikeString)))(function (ast) {
  ...
  var schemaFromGqlToPursWithCache = function (opts) {
      return function (v) {
          var go = function (v1) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(v1.value0.get(v.gql))(function (jsonMay) {
                      return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                          ...
                          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 230, column 13 - line 232, column 35): " + [ v2.constructor.name ]);
                      })())(function (eVal) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 226, column 3 - line 226, column 67): " + [ v1.constructor.name ]);
          };
          return go(v.cache);
      };
  };
  var schemasFromGqlToPurs = function (opts) {
      ...
      var collectSchemas = function (pursGqls) {
          return {
              schemas: Data_Functor.mapFlipped(Data_Functor.functorArray)(pursGqls)(function (pg) {
                  return {
                      code: GraphQL_Client_CodeGen_Schema.template({
                          name: pg.moduleName,
              ...
              enums: Data_Array.nubBy(Data_Function.on(Data_Ord.compare(Data_Ord.ordString))(function (v) {
                  ...
                  return Data_Functor.mapFlipped(Data_Functor.functorArray)(pg.enums)(function (e) {
                      return {
                          code: GraphQL_Client_CodeGen_Enum.template(modulePrefix)(e),
      ...
      var $194 = Data_Functor.map(Effect_Aff.functorAff)(Data_Functor.map(Data_Either.functorEither)(collectSchemas));
      var $195 = Data_Functor.map(Effect_Aff.functorAff)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither));
      var $196 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect_Aff.applicativeAff)(schemaFromGqlToPursWithCache(opts));
      return function ($197) {
          return $194($195($196($197)));
      };
  };
  var schemasFromGqlToPursJs = function (optsJs) {
      var opts = {
          externalTypes: Data_Map_Internal.fromFoldableWithIndex(Data_Ord.ordString)(Foreign_Object.foldableWithIndexObject)(optsJs.externalTypes),
          fieldTypeOverrides: Data_Functor.map(Data_Map_Internal.functorMap)(Data_Map_Internal.fromFoldableWithIndex(Data_Ord.ordString)(Foreign_Object.foldableWithIndexObject))(Data_Map_Internal.fromFoldableWithIndex(Data_Ord.ordString)(Foreign_Object.foldableWithIndexObject)(optsJs.fieldTypeOverrides)),
          dir: optsJs.dir,
      ...
      var $198 = Data_Functor.map(Effect_Aff.functorAff)(Data_Either.either(getError)(function (v) {
          return {
              result: v,
              parseError: "",
              argsTypeError: ""
      ...
      var $199 = schemasFromGqlToPurs(opts);
      return function ($200) {
          return Control_Promise.fromAff($198($199($200)));
      };
  };
  var decodeSchemasFromGqlToArgs = function (fn) {
      return function (f) {
          return function (gqlInput) {
              var gqlInputFromForeign = function (v) {
                  return {
                      gql: v.gql,
                      moduleName: v.moduleName,
                      cache: Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_Nullable.toMaybe(v.cache))(function (v1) {
                          return {
                              get: Data_Functor.map(Data_Functor.functorFn)((function () {
                                  var $201 = Data_Functor.map(Effect_Aff.functorAff)(Data_Nullable.toMaybe);
                                  return function ($202) {
                                      return $201(Control_Promise.toAff($202));
                                  };
                              })())(v1.get),
                              set: Data_Functor.map(Data_Functor.functorFn)(Control_Promise.toAff)(v1.set)
                          };
                      })
                  };
              };
              var v = Control_Monad_Except.runExcept(Foreign_Generic_Class.decode(Foreign_Generic_Class.recordDecode()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordNil)(new Data_Symbol.IsSymbol(function () {
                  return "modulePath";
              ...
              }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.objectDecode(Foreign_Generic_Class.objectDecode(Foreign_Generic_Class.recordDecode()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordNil)(new Data_Symbol.IsSymbol(function () {
                  return "typeName";
              }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.stringDecode))())(new Data_Symbol.IsSymbol(function () {
                  return "moduleName";
              }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.stringDecode))())))))())(new Data_Symbol.IsSymbol(function () {
                  return "externalTypes";
              }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.objectDecode(Foreign_Generic_Class.recordDecode()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordNil)(new Data_Symbol.IsSymbol(function () {
                  return "typeName";
              }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.stringDecode))())(new Data_Symbol.IsSymbol(function () {
                  return "moduleName";
              }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.stringDecode))()))))())(new Data_Symbol.IsSymbol(function () {
                  return "dir";
              }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.stringDecode))()))(f));
              if (v instanceof Data_Either.Left) {
                  return Control_Promise.fromAff(Control_Applicative.pure(Effect_Aff.applicativeAff)({
                      parseError: "",
                      argsTypeError: Data_Show.show(Data_List_Types.showNonEmptyList(Foreign.showForeignError))(v.value0),
                      result: Data_Monoid.mempty(Data_Monoid.monoidRecord()(Data_Monoid.monoidRecordCons(new Data_Symbol.IsSymbol(function () {
                          return "enums";
                      }))(Data_Monoid.monoidArray)()(Data_Monoid.monoidRecordCons(new Data_Symbol.IsSymbol(function () {
                          return "schemas";
              ...
              if (v instanceof Data_Either.Right) {
                  return fn(v.value0)(Data_Functor.map(Data_Functor.functorArray)(gqlInputFromForeign)(gqlInput));
              };
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.SchemaFromGqlToPurs (line 144, column 44 - line 152, column 63): " + [ v.constructor.name ]);
          };
      };
  };
  exports["decodeSchemasFromGqlToArgs"] = decodeSchemasFromGqlToArgs;
  exports["schemasFromGqlToPursJs"] = schemasFromGqlToPursJs;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["GraphQL.Client.CodeGen.Hasura"] = $PS["GraphQL.Client.CodeGen.Hasura"] || {};
  var exports = $PS["GraphQL.Client.CodeGen.Hasura"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_FunctorWithIndex = $PS["Data.FunctorWithIndex"];
  var Data_Tuple = $PS["Data.Tuple"];
  var Foreign_Object = $PS["Foreign.Object"];
  var GraphQL_Client_CodeGen_SchemaFromGqlToPurs = $PS["GraphQL.Client.CodeGen.SchemaFromGqlToPurs"];                
  var schemaFromGqlToPursJsHasura = function (opts) {
      return GraphQL_Client_CodeGen_SchemaFromGqlToPurs.schemasFromGqlToPursJs((function () {
          var $2 = !opts.isHasura;
          if ($2) {
              return opts;
          };
          return {
              ...
              fieldTypeOverrides: Foreign_Object.unions(Foreign_Object.foldableObject)(Data_FunctorWithIndex.mapWithIndex(Foreign_Object.functorWithIndexObject)(function (gqlObjectName) {
                  return function (obj) {
                      return Foreign_Object.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple(gqlObjectName, obj), new Data_Tuple.Tuple(gqlObjectName + "InsertInput", obj), new Data_Tuple.Tuple(gqlObjectName + "MinFields", obj), new Data_Tuple.Tuple(gqlObjectName + "MaxFields", obj), new Data_Tuple.Tuple(gqlObjectName + "SetInput", obj), Data_Tuple.Tuple.create(gqlObjectName + "BoolExp")(Data_Functor.map(Foreign_Object.functorObject)(function (o) {
                          return {
              ...
              })(opts.fieldTypeOverrides)),
              dir: opts.dir,
              modulePath: opts.modulePath,
              isHasura: opts.isHasura
          };
      })());
  };
  var schemaFromGqlToPursForeignHasura = GraphQL_Client_CodeGen_SchemaFromGqlToPurs.decodeSchemasFromGqlToArgs(schemaFromGqlToPursJsHasura);
  exports["schemaFromGqlToPursForeignHasura"] = schemaFromGqlToPursForeignHasura;
})(PS);
module.exports = PS["GraphQL.Client.CodeGen.Hasura"];
