...
(function($PS) {
  ...
  var prependLines = function (pre) {
      var $166 = Data_Functor.map(Data_Functor.functorArray)(function (l) {
          var $46 = l === "";
          if ($46) {
              return l;
          };
      ...
      return function ($167) {
          return fromLines($166(toLines($167)));
      };
  };
  ...
  var gqlToPursEnums = (function () {
      var enumValueToPurs = (function () {
          var $168 = Data_Newtype.unwrap(Data_GraphQL_AST.enumValueNewtype);
          return function ($169) {
              return typeName($168($169));
          };
      })();
      ...
      var definitionToPurs = function (v) {
          ...
          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 418, column 22 - line 421, column 54): " + [ v.constructor.name ]);
      };
      ...
      return function (doc) {
          ...
          var rootOperationTypeDefinitionToPurs = function (v1) {
              var opStr = (function () {
                  ...
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 180, column 13 - line 183, column 41): " + [ v1.operationType.constructor.name ]);
              })();
          ...
          var scalarTypeDefinitionToPurs = function (v1) {
              ...
              return Data_Monoid.guard(Data_Monoid.monoidString)(Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(tName)(builtInTypes))((function () {
                  ...
                  throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 197, column 7 - line 214, column 33): " + [ v2.constructor.name ]);
              })());
          };
          ...
          var inputValueDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return descriptionToDocComment(v1.description) + (v1.name + (" :: " + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 364, column 10 - line 366, column 60): " + [ v2.constructor.name ]);
                  })()));
              };
          };
          ...
          var fieldDefinitionToPurs = function (objectName) {
              return function (v1) {
                  return descriptionToDocComment(v1.description) + (v1.name + (" :: " + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(argumentsDefinitionToPurs)(v1.argumentsDefinition) + (function () {
                      ...
                      throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 276, column 10 - line 278, column 60): " + [ v2.constructor.name ]);
                  })())));
              };
          };
          ...
          var typeDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 186, column 26 - line 192, column 143): " + [ v1.constructor.name ]);
          };
          var typeSystemDefinitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 165, column 32 - line 168, column 118): " + [ v1.constructor.name ]);
          };
          var definitionToPurs = function (v1) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 159, column 22 - line 162, column 54): " + [ v1.constructor.name ]);
          };
  ...
  var schemaFromGqlToPursWithCache = function (opts) {
      return function (v) {
          var go = function (v1) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(v1.value0.get(v.schema))(function (jsonMay) {
                      return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                          ...
                          throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 100, column 13 - line 102, column 35): " + [ v2.constructor.name ]);
                      })())(function (eVal) {
              ...
              throw new Error("Failed pattern match at GraphQL.Client.CodeGen.Schema (line 96, column 3 - line 96, column 70): " + [ v1.constructor.name ]);
          };
